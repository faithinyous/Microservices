...
export default class User {
  ...
  VALUES(
    ...
    await cassandraExe(query, req.body, (err:any, result:any) => { assert.ifError(err); console.log('The cost per orange is $' + result.rows[0].price_p_item)});
